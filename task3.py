...
real_pattern = "основне завдання"
fake_pattern = "fake text"

# Вимірюємо час для реального підрядка
time_bm_real = timeit.timeit(lambda: boyer_moore(text1, real_pattern), number=100)
time_kmp_real = timeit.timeit(lambda: knuth_morris_pratt(text1, real_pattern), number=100)
time_rk_real = timeit.timeit(lambda: rabin_karp(text1, real_pattern), number=100)

# Вимірюємо час для вигаданого підрядка
time_bm_fake = timeit.timeit(lambda: boyer_moore(text1, fake_pattern), number=100)
time_kmp_fake = timeit.timeit(lambda: knuth_morris_pratt(text1, fake_pattern), number=100)
time_rk_fake = timeit.timeit(lambda: rabin_karp(text1, fake_pattern), number=100)

# Виводимо результати
print("Стаття 1. Час для реального підрядка:")
print("Боєра-Мура:", time_bm_real)
print("Кнута-Морріса-Пратта:", time_kmp_real)
print("Рабіна-Карпа:", time_rk_real)

print("Стаття 1. Час для вигаданого підрядка:")
print("Боєра-Мура:", time_bm_fake)
print("Кнута-Морріса-Пратта:", time_kmp_fake)
print("Рабіна-Карпа:", time_rk_fake)

real_pattern = "формування рекомендацій"
fake_pattern = "fake text"

# Вимірюємо час для реального підрядка
time_bm_real = timeit.timeit(lambda: boyer_moore(text2, real_pattern), number=100)
time_kmp_real = timeit.timeit(lambda: knuth_morris_pratt(text2, real_pattern), number=100)
time_rk_real = timeit.timeit(lambda: rabin_karp(text2, real_pattern), number=100)

# Вимірюємо час для вигаданого підрядка
time_bm_fake = timeit.timeit(lambda: boyer_moore(text2, fake_pattern), number=100)
time_kmp_fake = timeit.timeit(lambda: knuth_morris_pratt(text2, fake_pattern), number=100)
time_rk_fake = timeit.timeit(lambda: rabin_karp(text2, fake_pattern), number=100)
...
print("Стаття2. Час для вигаданого підрядка:")
print("Боєра-Мура:", time_bm_fake)
print("Кнута-Морріса-Пратта:", time_kmp_fake)
print("Рабіна-Карпа:", time_rk_fake)
